...
urlpatterns = [
	...
	path('customer/carinfo/<str:pk>/',views.carPage, name='carPage'),
	path('updateView/',views.updateView, name='updateView'),
	path('createOrder/<str:pk>/tac',views.tac,name='tac'),
	path('createOrder/<str:pk>/check', views.check, name='check'),
